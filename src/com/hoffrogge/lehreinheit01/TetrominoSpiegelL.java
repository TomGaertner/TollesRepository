...
public class TetrominoSpiegelL implements GeometrischeFigur {

	private int xKoordinate;
	private int yKoordinate;

	public TetrominoSpiegelL(int xKoordinate, int yKoordinate) {
	...
	public void zeichnen(Graphics graphics) {
		...
		Rechteck rechteck = new Rechteck(xKoordinate, yKoordinate + 30);
